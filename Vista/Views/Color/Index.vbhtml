@ModelType IEnumerable(Of EE.Color)
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-eyedropper"></i>Listado de Colores
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered table-hover" id="tablaColores">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Codigo</th>
                        ...
                        @For Each item In Model
                            ...
                            @<tr class="odd gradeX">
                                ...
                                <td class="text-center">
                                    @Code
                                    If User.IsInRole("ConsultarColor") Then
