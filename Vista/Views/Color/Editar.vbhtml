    ...
    <div class="col-md-12">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-eyedropper"></i> Editar Color
                    <div class="tools">
            ...
            <div class="portlet-body form">
                @Using Html.BeginForm()
                    ...
                    @<div class="form-body">
                        ...
                        <div class="form-group @(If(Html.ViewData.ModelState.IsValidField(Convert.ToString(Html.IdFor(Function(model) model.Codigo))), Nothing, "has-error"))">
                            ...
                            @Html.ValidationMessageFor(Function(model) model.Codigo, Nothing, New With {.class = "help-block"})
                        </div>
                    </div>
