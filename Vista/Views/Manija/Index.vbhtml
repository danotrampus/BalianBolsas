@ModelType IEnumerable(Of EE.Manija)
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-headphones"></i>Listado de Manijas
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            @Code
                                If User.IsInRole("CrearManija") Then
                            @<div class="btn-group">
                ...
                <table class="table table-striped table-bordered table-hover" id="tablaManijas">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Color</th>
                        ...
                        @For Each item In Model
                            ...
                            @<tr class="odd gradeX">
                                ...
                                <td class="text-center">
                                    @Code
                                    If User.IsInRole("ConsultarManija") Then
