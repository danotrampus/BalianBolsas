...
<p>
    En BalianBolsas.com.ar, en adelante ‘este sitio web’, respetamos su información personal y en vista de cumplir con las políticas de seguridad respectivas concernientes a todo sitio web, que deberían ser obligatorias, informo a ustedes lo siguiente.
</p>
<h4>Privacidad de los datos personales:</h4>
...
<h4>
    Estadísticas y otros sitios afines a BalianBolsa.com.ar
</h4>

    Para el correcto funcionamiento de este blog, se hacen uso de diversos cookies, tanto del sitio como de nuestros proveedores (como se expuso en el punto anterior), almacenados en su equipo o mediante el uso de algún script. Ver el caso del Cookie Darth.
