@ModelType IEnumerable(Of EE.Categoria)
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-eyedropper"></i>Listado de Categorias
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            @Code
                                If User.IsInRole("CrearColor") Then
                            @<div class="btn-group">
                ...
                <table class="table table-striped table-bordered table-hover" id="tablaCategorias">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Acciones</th>
                        ...
                        @For Each item In Model
                            ...
                            @<tr class="odd gradeX">
                                ...
                                <td class="text-center">
                                    @Code
                                    If User.IsInRole("ConsultarCategoria") Then
