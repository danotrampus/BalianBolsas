@ModelType IEnumerable(Of EE.Polimero)
    ...
    <div class="col-md-12">
        ...
        <div class="portlet box grey-cascade">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-object-ungroup"></i>Listado de Polímeros
                </div>
                <div class="tools">
            ...
            <div class="portlet-body">
                <div class="table-toolbar">
                    <div class="row">
                        <div class="col-md-6">
                            @Code
                                If User.IsInRole("CrearPolimero") Then
                            @<div class="btn-group">
                ...
                <table class="table table-striped table-bordered table-hover" id="tablaPolimeros">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                            <th>Densidad</th>
                    ...
                    <tbody>
                        @For Each item In Model
                            ...
                            @<tr class="odd gradeX">
                                ...
                                <td>
                                    @Html.DisplayFor(Function(modelItem) currentItem.Densidad)
                                </td>
                                <td>
                                    @Html.DisplayFor(Function(modelItem) currentItem.Color.Nombre)
                                </td>
                                <td>
                                ...
                                <td class="text-center">
                                    @Code
                                    If User.IsInRole("ConsultarPolimero") Then
